...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in)
{
	...
	my_light->setAmbientColour(1.0f, 0.0f, 0.2f, 1.0f);
	...
	light_2->setDiffuseColour(0.0f, 1.0f, 0.0f, 1.0f);
...
bool App1::render()
{
	XMMATRIX worldMatrix, viewMatrix, projectionMatrix, matrix1, matrix2, orthoMatrix, orthoViewMatrix;
	...
	//translate by x
	//worldMatrix = XMMatrixTranslation(-50.0f, rotate, 0.0f);
...
void App1::RenderToTexture()
{
	...
	//camera->setRotation(0.f, 0.0f, 90.0f);
	...
	worldMatrix = renderer->getWorldMatrix();
	viewMatrix = topDownCamera->getViewMatrix();
	projectionMatrix = renderer->getProjectionMatrix();
	...
	/*manipShader->setShaderParameters(renderer->getDeviceContext(), worldMatrix, viewMatrix, projectionMatrix,
		textureMgr->getTexture("default"), my_light, light_2, camera, counter, height, length);*/
