...
MyTessMesh::MyTessMesh(ID3D11Device* device, ID3D11DeviceContext* deviceContext)
{
	initBuffers(device);
}
...
void MyTessMesh::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void MyTessMesh::sendData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
