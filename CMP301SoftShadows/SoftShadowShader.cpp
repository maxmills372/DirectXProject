...
void SoftShadowShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView* shadowTexture,  Light* light)
{
	HRESULT result;
...
void SoftShadowShader::render(ID3D11DeviceContext* deviceContext, int indexCount)
{
