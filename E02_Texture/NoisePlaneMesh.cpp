...
NoisePlaneMesh::NoisePlaneMesh(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int lresolution)
{
...
void NoisePlaneMesh::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
