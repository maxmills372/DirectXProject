...
void DirectionalBlurShader::initShader(WCHAR* vsFilename, WCHAR* psFilename)
{
...
void DirectionalBlurShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, float width)
{
	HRESULT result;
...
void DirectionalBlurShader::render(ID3D11DeviceContext* deviceContext, int indexCount)
{
