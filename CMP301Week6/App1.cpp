...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in)
{
	...
	my_light->setAmbientColour(0.0f, 0.0f, 0.4f, 1.0f);
...
bool App1::render()
{
	...
	lightShader->setShaderParameters(renderer->getDeviceContext(), worldMatrix, viewMatrix, projectionMatrix, textureMgr->getTexture("default"), my_light,camera);
	//// Render object (combination of mesh geometry and shader process
