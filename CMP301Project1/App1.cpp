...
void App1::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in)
{
	...
	my_light = new Light;
	my_light->setDiffuseColour(0.8f, 0.0f, 0.5f, 1.0f);
	my_light->setDirection(0.5f, -0.5f, 0.0f);
...
bool App1::render()
{
	...
	//	 Dont need this as we have the light shader:
	...
	lightShader->setShaderParameters(renderer->getDeviceContext(), worldMatrix, viewMatrix, projectionMatrix,textureMgr->getTexture("default"),my_light);
	//// Render object (combination of mesh geometry and shader process
